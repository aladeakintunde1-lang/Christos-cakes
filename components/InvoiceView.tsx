                ...
                <td className="py-8 px-4">
                  ...
                  <div className="mt-3 space-y-2">
                    ...
                    {order.inspirationImage && (
                      <div className="pt-4">
                        <p className="text-[9px] font-black text-slate-300 uppercase tracking-widest mb-2">Inspiration Image</p>
                        <div className="rounded-2xl overflow-hidden border border-slate-100 max-w-[200px]">
